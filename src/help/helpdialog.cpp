    ...
    ui(new Ui::HelpDialog)
{
    ...
    QString helpText = "<html>"
                       ...
                       "<p><a href=\"https://gitee.com/liuminghang/fantascene-dynamic-wallpaper/wikis/pages\">wiki(gitee)</a></p>"
                       "<p><a href=\"https://github.com/dependon/fantascene-dynamic-wallpaper/wiki\">wiki(github)</a></p>"
                       "<p>新建的qq群，期待你的加入</p>"
                       "<h1>917552088</h1>"
                       ...
                       "<p>软件可以支持视频格式和html的两种方式打开,可以由本地的html或者一个视频壁纸网址来使用web壁纸，视频壁纸为本地文件 </p>"
                       "<p>星火视频仓库  1.8.4版本引入，当前为试运行，采用学生云机器和家庭服务器作为下载，视频量比较少，可以向作者发送喜爱的视频  </p>"
                       "</body>"
                       "</html>";
