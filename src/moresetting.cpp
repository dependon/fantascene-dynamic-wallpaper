    ...
    ui(new Ui::MoreSetting)
{
    ...
    m_languageMap["zh_CN"] = "中文";
    m_languageMap["zh_TW"] = "繁體中文(中国台湾)";
    m_languageMap["zh_HK"] = "繁體中文(中国香港)";
    m_languageMap["es"] = "Español";
    m_languageMap["pl"] = "Polski";
    m_languageMap["ja"] = "日本語";
    m_languageMap["de"] = "Deutsch";
    m_languageMap["ko"] = "한국어";
    m_languageMap["it"] = "Italiano";
    m_languageMap["fr"] = "Français";
    m_languageMap["ru"] = "Русский";
    m_languageMap["pt"] = "Português";
    m_languageMap["pt_BR"] = "Português (Brasil)";
    m_languageMap["fi"] = "Suomi";
    m_languageMap["vi"] = "Tiếng Việt";
    m_languageMap["tr"] = "Türkçe";
    m_languageMap["th"] = "ภาษาไทย";
    m_languageMap["hu"] = "Magyar";
    m_languageMap["sv"] = "Svenska";
    m_languageMap["sk"] = "Slovenčina";
    m_languageMap["ro"] = "Română";
    m_languageMap["ms"] = "Bahasa Melayu";
    m_languageMap["nl"] = "Nederlands";
    m_languageMap["et"] = "Eesti keel";
    m_languageMap["bg"] = "Български";
    m_languageMap["cs"] = "Čeština";
    m_languageMap["da"] = "Dansk sprog";
    m_languageMap["el"] = "Ελληνική γλώσσα";
